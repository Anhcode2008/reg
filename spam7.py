...
\033[31m╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝     ╚═╝   ╚══════╝╚═╝╚═╝  ╚═╝╚═╝     ╚═╝\033[0m
           ...
           \033[33m     © Copyright HQH TEAM \033[0m
           \033[33m     TELEGRAM: t.me/hqhteam \033[0m
            \033[33m     Tool by huypc dev bố cho ăn cứt ❗ \033[0m
"""
for i in ban:
    sys.stdout.write(i)
    sys.stdout.flush()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("❌ Dùng: python smm.py <sdt> <so_lan>")
        sys.exit(1)
